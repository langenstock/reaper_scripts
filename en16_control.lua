local DEBUG_CONSOLE_ON = true -- Change this to true in order to spam console with info about the controller being touched
...
local midiKnobMap = {
    row_1_c_1 = 'midi:b1:4a',
    row_2_c_1 = 'midi:b1:5d',
    row_1_c_2 = 'midi:b1:47',
    row_2_c_2 = 'midi:b1:12',
    row_1_c_3 = 'midi:b1:4c',
    row_2_c_3 = 'midi:b1:13',
    row_1_c_4 = 'midi:b1:4d',
    row_2_c_4 = 'midi:b1:10',
}
...
function main()
    ...
    if numOfSelItems > 0 then
        ...
        if contextStr and val then
            ...
            if contextStr == midiKnobMap.row_1_c_1 then
                nudgeItemVolume(val, items)
            elseif contextStr == midiKnobMap.row_2_c_1 then
                nudgePlayRate(val, items)
            elseif contextStr == midiKnobMap.row_1_c_2 then
                nudgeItemPitch(val, items)
            elseif contextStr == midiKnobMap.row_2_c_2 then
                -- Session master Rate?
            elseif contextStr == midiKnobMap.row_1_c_3 then
                trackEffectsShelfGain(val, items, shelfTypes.lowShelf, eqParams.gain)
            elseif contextStr == midiKnobMap.row_2_c_3 then
                trackEffectsShelfGain(val, items, shelfTypes.lowShelf, eqParams.freq)
            elseif contextStr == midiKnobMap.row_1_c_4 then
                --trackEffectsShelfGain(val, items, shelfTypes.highShelf, eqParams.gain)
            elseif contextStr == midiKnobMap.row_2_c_4 then
                --trackEffectsShelfGain(val, items, shelfTypes.highShelf, eqParams.freq)
            end
